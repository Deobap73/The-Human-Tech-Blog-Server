...
// Publish draft as post (copies all multilanguage translations, image, tags, categories)
export const publishDraft = async (req: Request, res: Response) => {
  try {
    ...
    // Copy ALL translations (en from main fields, others from draft.translations)
    ...
    // Include other languages if present
